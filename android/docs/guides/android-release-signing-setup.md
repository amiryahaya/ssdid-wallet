...
This guide walks through generating an Android signing keystore and configuring GitHub repository secrets for the `android-release` CI/CD workflow.
...
After adding all 4 secrets, the **Actions secrets** page should show:
