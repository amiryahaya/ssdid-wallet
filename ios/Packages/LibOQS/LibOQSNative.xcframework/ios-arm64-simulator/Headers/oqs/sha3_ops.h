 ...
 *
 * @param[out] output 32-byte hash output.
 * @param[in] input Input data.
 * @param[in] inplen Length of input in bytes.
 */
OQS_API void OQS_SHA3_sha3_256(uint8_t *output, const uint8_t *input, size_t inplen);
