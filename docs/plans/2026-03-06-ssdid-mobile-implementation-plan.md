...
**Reference:** Design doc at `docs/plans/2026-03-06-ssdid-mobile-app-design.md`
...
```bash
cd /Users/amirrudinyahaya/Workspace/ssdid-mobile
mkdir -p android
```
...
```bash
mkdir -p android/app/src/main/java/my/ssdid/mobile/{domain/{model,crypto,vault,verifier,transport},feature/{onboarding,identity,credentials,scan,registration,auth,transaction,history,settings},platform/{keystore,biometric,deeplink,i18n}}
mkdir -p android/app/src/main/cpp
mkdir -p android/app/src/main/res/{values,values-ms,values-zh}
mkdir -p android/app/src/test/java/my/ssdid/mobile/{domain,feature}
```

**Step 3: Create Application class with Hilt**

Create `android/app/src/main/java/my/ssdid/mobile/SsdidApp.kt`:
```kotlin
...
**Files:**
- Create: `android/app/src/main/java/my/ssdid/mobile/domain/model/Did.kt`
- Create: `android/app/src/main/java/my/ssdid/mobile/domain/model/DidDocument.kt`
- Create: `android/app/src/main/java/my/ssdid/mobile/domain/model/VerifiableCredential.kt`
- Create: `android/app/src/main/java/my/ssdid/mobile/domain/model/Proof.kt`
- Create: `android/app/src/main/java/my/ssdid/mobile/domain/model/Algorithm.kt`
- Create: `android/app/src/main/java/my/ssdid/mobile/domain/model/Identity.kt`
- Test: `android/app/src/test/java/my/ssdid/mobile/domain/model/DidTest.kt`
- Test: `android/app/src/test/java/my/ssdid/mobile/domain/model/DidDocumentTest.kt`

**Step 1: Write failing test for DID generation**

Create `android/app/src/test/java/my/ssdid/mobile/domain/model/DidTest.kt`:
```kotlin
...
Run: `cd android && ./gradlew test --tests "my.ssdid.mobile.domain.model.DidTest"`
...
Create `android/app/src/test/java/my/ssdid/mobile/domain/model/DidDocumentTest.kt`:
```kotlin
package my.ssdid.mobile.domain.model
...
Run: `cd android && ./gradlew test --tests "my.ssdid.mobile.domain.model.*"`
Expected: ALL PASS

**Step 9: Commit**

```bash
git add android/app/src/main/java/my/ssdid/mobile/domain/model/
git add android/app/src/test/java/my/ssdid/mobile/domain/model/
...
**Files:**
- Create: `android/app/src/main/java/my/ssdid/mobile/domain/crypto/CryptoProvider.kt`
- Create: `android/app/src/main/java/my/ssdid/mobile/domain/crypto/KeyPairResult.kt`
- Create: `android/app/src/main/java/my/ssdid/mobile/domain/crypto/ClassicalProvider.kt`
- Create: `android/app/src/main/java/my/ssdid/mobile/domain/crypto/Multibase.kt`
- Test: `android/app/src/test/java/my/ssdid/mobile/domain/crypto/ClassicalProviderTest.kt`
- Test: `android/app/src/test/java/my/ssdid/mobile/domain/crypto/MultibaseTest.kt`
...
Create `android/app/src/test/java/my/ssdid/mobile/domain/crypto/ClassicalProviderTest.kt`:
```kotlin
package my.ssdid.mobile.domain.crypto
...
Run: `cd android && ./gradlew test --tests "my.ssdid.mobile.domain.crypto.ClassicalProviderTest"`
...
Create `android/app/src/test/java/my/ssdid/mobile/domain/crypto/MultibaseTest.kt`:
```kotlin
package my.ssdid.mobile.domain.crypto
...
Run: `cd android && ./gradlew test --tests "my.ssdid.mobile.domain.crypto.*"`
Expected: ALL PASS

**Step 7: Commit**

```bash
git add android/app/src/main/java/my/ssdid/mobile/domain/crypto/
git add android/app/src/test/java/my/ssdid/mobile/domain/crypto/
...
**Files:**
- Copy: KAZ-Sign Kotlin binding from `/Users/amirrudinyahaya/Workspace/PQC-KAZ/SIGN/bindings/` to `android/app/src/main/java/my/ssdid/mobile/domain/crypto/kazsign/`
- Create: `android/app/src/main/cpp/CMakeLists.txt`
- Create: `android/app/src/main/java/my/ssdid/mobile/domain/crypto/PqcProvider.kt`
- Test: `android/app/src/test/java/my/ssdid/mobile/domain/crypto/PqcProviderTest.kt`
...
cp -r /Users/amirrudinyahaya/Workspace/PQC-KAZ/SIGN/bindings/kotlin/* android/app/src/main/java/my/ssdid/mobile/domain/crypto/kazsign/
```

Note: Examine the existing binding at copy time. Adjust package name to `my.ssdid.mobile.domain.crypto.kazsign` and ensure JNI method signatures match.
...
Create `android/app/src/test/java/my/ssdid/mobile/domain/crypto/PqcProviderTest.kt`:
```kotlin
package my.ssdid.mobile.domain.crypto
...
Run: `cd android && ./gradlew test --tests "my.ssdid.mobile.domain.crypto.PqcProviderTest"`
Expected: PASS

**Step 6: Commit**

```bash
git add android/app/src/main/cpp/ android/app/src/main/java/my/ssdid/mobile/domain/crypto/kazsign/
git add android/app/src/main/java/my/ssdid/mobile/domain/crypto/PqcProvider.kt
git add android/app/src/test/java/my/ssdid/mobile/domain/crypto/PqcProviderTest.kt
...
**Files:**
- Create: `android/app/src/main/java/my/ssdid/mobile/domain/vault/Vault.kt`
- Create: `android/app/src/main/java/my/ssdid/mobile/domain/vault/VaultImpl.kt`
- Create: `android/app/src/main/java/my/ssdid/mobile/domain/vault/CredentialStore.kt`
- Create: `android/app/src/main/java/my/ssdid/mobile/platform/keystore/KeystoreManager.kt`
- Create: `android/app/src/main/java/my/ssdid/mobile/platform/keystore/AndroidKeystoreManager.kt`
- Test: `android/app/src/test/java/my/ssdid/mobile/domain/vault/VaultTest.kt`
...
Create `android/app/src/main/java/my/ssdid/mobile/domain/vault/VaultStorage.kt`:
```kotlin
package my.ssdid.mobile.domain.vault
...
Create `android/app/src/test/java/my/ssdid/mobile/domain/vault/VaultTest.kt`:
```kotlin
package my.ssdid.mobile.domain.vault
...
class VaultTest {
    ...
    fun `storeCredential and listCredentials round trip`() = runTest {
        val vc = my.ssdid.mobile.domain.model.VerifiableCredential(
            id = "urn:uuid:test",
            type = listOf("VerifiableCredential"),
            issuer = "did:ssdid:issuer",
            issuanceDate = "2026-03-06T00:00:00Z",
            credentialSubject = my.ssdid.mobile.domain.model.CredentialSubject(id = "did:ssdid:subject"),
            proof = my.ssdid.mobile.domain.model.Proof(
...
Create `android/app/src/test/java/my/ssdid/mobile/domain/vault/FakeVaultStorage.kt`:
```kotlin
package my.ssdid.mobile.domain.vault
...
Run: `cd android && ./gradlew test --tests "my.ssdid.mobile.domain.vault.*"`
Expected: ALL PASS

**Step 7: Commit**

```bash
git add android/app/src/main/java/my/ssdid/mobile/domain/vault/
git add android/app/src/main/java/my/ssdid/mobile/platform/keystore/
git add android/app/src/test/java/my/ssdid/mobile/domain/vault/
...
**Files:**
- Create: `android/app/src/main/java/my/ssdid/mobile/domain/transport/RegistryApi.kt`
- Create: `android/app/src/main/java/my/ssdid/mobile/domain/transport/ServerApi.kt`
- Create: `android/app/src/main/java/my/ssdid/mobile/domain/transport/SsdidHttpClient.kt`
- Create: `android/app/src/main/java/my/ssdid/mobile/domain/transport/dto/` (all DTOs)
- Test: `android/app/src/test/java/my/ssdid/mobile/domain/transport/SsdidHttpClientTest.kt`

**Step 1: Create DTO classes**

Create `android/app/src/main/java/my/ssdid/mobile/domain/transport/dto/RegistryDtos.kt`:
```kotlin
...
Create `android/app/src/main/java/my/ssdid/mobile/domain/transport/dto/ServerDtos.kt`:
```kotlin
package my.ssdid.mobile.domain.transport.dto
...
```bash
git add android/app/src/main/java/my/ssdid/mobile/domain/transport/
...
**Files:**
- Create: `android/app/src/main/java/my/ssdid/mobile/domain/verifier/Verifier.kt`
- Create: `android/app/src/main/java/my/ssdid/mobile/domain/verifier/VerifierImpl.kt`
- Test: `android/app/src/test/java/my/ssdid/mobile/domain/verifier/VerifierTest.kt`
...
```bash
git add android/app/src/main/java/my/ssdid/mobile/domain/verifier/
...
**Files:**
- Create: `android/app/src/main/java/my/ssdid/mobile/domain/SsdidClient.kt`
- Test: `android/app/src/test/java/my/ssdid/mobile/domain/SsdidClientTest.kt`
...
import my.ssdid.mobile.domain.crypto.Multibase
import my.ssdid.mobile.domain.model.*
import my.ssdid.mobile.domain.transport.ServerApi
...
```bash
git add android/app/src/main/java/my/ssdid/mobile/domain/SsdidClient.kt
...
**Files:**
- Create: `android/app/src/main/java/my/ssdid/mobile/di/AppModule.kt`
...
```bash
git add android/app/src/main/java/my/ssdid/mobile/di/
...
**Files to create:**
- `android/app/src/main/java/my/ssdid/mobile/ui/theme/Theme.kt`
- `android/app/src/main/java/my/ssdid/mobile/ui/theme/Color.kt`
- `android/app/src/main/java/my/ssdid/mobile/ui/theme/Type.kt`
- `android/app/src/main/java/my/ssdid/mobile/ui/navigation/NavGraph.kt`
- `android/app/src/main/java/my/ssdid/mobile/ui/navigation/Screen.kt`
- `android/app/src/main/java/my/ssdid/mobile/MainActivity.kt`
- One file per screen under `android/app/src/main/java/my/ssdid/mobile/feature/*/`
...
**Files:**
- Create: `android/app/src/main/java/my/ssdid/mobile/platform/scan/QrScanner.kt`
- Create: `android/app/src/main/java/my/ssdid/mobile/feature/scan/ScanViewModel.kt`
- Create: `android/app/src/main/java/my/ssdid/mobile/feature/scan/ScanScreen.kt`
...
**Files:**
- Modify: `android/app/src/main/java/my/ssdid/mobile/MainActivity.kt`
- Create: `android/app/src/main/java/my/ssdid/mobile/platform/deeplink/DeepLinkHandler.kt`
...
**Files:**
- Create: `android/app/src/main/java/my/ssdid/mobile/platform/biometric/BiometricAuthenticator.kt`
...
**Files:**
- Create: `android/app/src/main/java/my/ssdid/mobile/platform/storage/DataStoreVaultStorage.kt`
